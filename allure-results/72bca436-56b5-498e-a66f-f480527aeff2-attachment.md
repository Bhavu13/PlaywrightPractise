...
Call log:
  - waiting for locator('.action__submit')
    - locator resolved to <a _ngcontent-utf-c35="" class="btnn action__submit ng-star-inserted">…</a>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="ta-backdrop" _ngcontent-utf-c32=""></div> from <div _ngcontent-utf-c35="" class="user__address">…</div> subtree intercepts pointer events
